...
args=(
    ...
    --disaggregation-bootstrap-port $BPORT
    ...
    --freq-manager-interval $freq_interval
    --freq-manager-latency-lookup-table-path ./prediction/latency-prefill-8b.csv

    # settings
    --freq-manager-slo 800
    --freq-manager-slo margin 0.35
    --freq-manager-f-list 1005 1410

    # rps & tps
    --freq-manager-tps-threshold 1125000  # sharegpt mean(inlen) = 250, rps = 45
    --freq-manager-tps-window 3
    --freq-manager-rps-threshold 100000
